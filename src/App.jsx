          ...
          <section className="bg-white rounded-[32px] p-5 sm:p-8 shadow-2xl mb-8 border border-slate-200/60">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between mt-12 bg-slate-900 p-6 rounded-[40px] text-white shadow-2xl gap-6">
               ...
               <div className="flex flex-wrap gap-2 sm:gap-3 w-full lg:w-auto justify-center lg:justify-end">
                 ...
                 <input id="mega-upload-input" type="file" multiple accept="image/jpeg, image/png, image/jpg, image/webp" className="w-px h-px opacity-0 absolute overflow-hidden -z-10" onChange={handleMegaUpload} />
               </div>
            </div>
          </section>
